...
rm -rf $TARG_DIR
rm -rf $BUILD_DIR/bin/Release/net6.0/linux-x64/publish
pushd $BUILD_DIR
dotnet publish -c Release -r linux-x64 -f net6.0
popd
mkdir -p $TARG_DIR
cp -rv $BUILD_DIR/bin/Release/net6.0/linux-x64/publish/. $TARG_DIR
pwd
